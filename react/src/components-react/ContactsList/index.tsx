...
import EventsManager, {
  T_RefreshContactsListPayload,
} from "~/modules/events-manager";
...
function ContactsList() {
  ...
  function handleTelClick(
    event: T_ReactOnClickEventObject<HTMLAnchorElement>
  ): void {
    event.stopPropagation();
  }

  async function handleDeleteContactClick(
    ...
    <div className="ContactsList">
      <ul className="ContactsList__list">
        {contacts.map((contact) => {
          ...
          return (
            <li key={contact.id} className="ContactsList__list__item">
