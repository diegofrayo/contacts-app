...
export type T_ReactSetState<G_State> = React.Dispatch<
  React.SetStateAction<G_State>
>;
...
export type T_ReactOnClickEventObject<G_HTMLElement> =
  React.MouseEvent<G_HTMLElement>;
...
export type T_ReactOnChangeEventHandler<G_HTMLElement> =
  React.ChangeEventHandler<G_HTMLElement>;
...
export type T_ReactOnSubmitEventHandler<G_HTMLElement> =
  React.FormEventHandler<G_HTMLElement>;
